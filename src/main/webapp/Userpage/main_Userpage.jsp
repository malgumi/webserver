...
<a class="logo" href="http://localhost:8080/webserver/main.jsp" style="margin-top:5px;"><img src="http://localhost:8080/webserver/img/logo.png"></a>
	...
	<div class="container" style="width: 60%;">
			<div style="margin-top:80px;">
				<form method="post" action="update_UserAction.jsp?user_id=<%= user_id %>" style="margin-top: 50px; border:1px solid #c2c2c2; background-color: white; text-align: center;">
					<h3 style="text-align: center; background-color: #f5f2ea; padding: 10px 0px 10px 0px;">회원 정보 수정</h3> <br>
					...
					<label style="text-align: left; font-size: 14px; color: #666">
						<span >비밀번호</span><br>
						<input type="password" name="password" maxlength="50" style="width: 40%" value="<%=user.getPassword()%>">	
					</label>
					<br><br>
					<label style="text-align: left; font-size: 14px; color: #666">
						<span>이름</span><br>
